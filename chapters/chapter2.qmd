...
classifier, but will generate three outputs, one per hierarchy level (illustrated below).
...
this model uses a hierarchical loss.[^note: This differs from FastText estimated using hierarchical softmax (https://fasttext.cc/docs/en/supervised-tutorial.html#scaling-things-up) which computes a tree from the features, not between the classes]
The hierarchical loss is based on
