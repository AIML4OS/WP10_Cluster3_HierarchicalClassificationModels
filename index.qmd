---
title: "Cluster 3 Report: Hierarchical textclassification"
subtitle: "From Text to Code (AIML WP10)" 
include-before-body:
...
author:
  ...
  - name: Johannes Gussenbauer
    url: https://github.com/JohannesGuss
    email: johannes.gussenbauer@statistik.gv.at
  - name: JHD
    email: dstaiml4osjhd@tutanota.com
date: "2026-04-02"
...
description: |
    These pages are designed to serve as a report and tutorial on how to implement hierarchical structures into textclassification models, and summarize our findings. The respective github repository can be found [here](https://github.com/AIML4OS/WP10_Cluster3_HierarchicalClassificationModels).
    The code implementations to all models and a running toy example can be found [here](https://datalab.sspcloud.fr/launcher/ide/rstudio?name=dev_Hierarchical_Textclass&version=2.4.3&s3=region-79669f20&init.personalInit=%C2%ABhttps%3A%2F%2Fraw.githubusercontent.com%2FAIML4OS%2FWP10_Cluster3_HierarchicalClassificationModels%2Frefs%2Fheads%2Fmain%2Fsspcloud%2Finit-trainees.sh%C2%BB&init.personalInitArgs=%C2%ABexercises%2Fexercise1.qmd%C2%BB&git.repository=%C2%ABhttps%3A%2F%2Fgithub.com%2FAIML4OS%2FWP10_Cluster3_HierarchicalClassificationModels%C2%BB&git.branch=%C2%ABmain%C2%BB&networking.user.enabled=true&autoLaunch=true).
